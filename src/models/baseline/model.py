...
class BaselineLinear(nn.Module):
    """A minimal baseline that predicts 5-component probabilities.
    ...
    def __init__(self, input_channels: int = 5, num_classes: int = 5, hidden: int = 0, dropout: float = 0.0):
        super().__init__()
...
class BaselineFrequencyDataset(Dataset):
    ...
    to a valid probability distribution across 5 classes.
    """
